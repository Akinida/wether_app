...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        const {
            weather,
            dt: dateUnix,
            sys: { sunrise: sunriseUnixUTC, sunsetUnixUTC },
                    ...
                    <div class="card card-sm highlight-card one">
                        ...
                        <div class="wrapper">
                            ...
                            <ul class="card-list">
                                ...
                                <li class="card-item">
                                    <p class="title-1">${pm2_5.toPrecision(3)}
                                    </p>
                                ...
                                <li class="card-item">
                                    <p class="title-1">${so2.toPrecision(3)}
                                    </p>
                                ...
                                <li class="card-item">
                                    <p class="title-1">${no2.toPrecision(3)}
                                    </p>
                                ...
                                <li class="card-item">
                                    <p class="title-1">${o3.toPrecision(3)}
                                    </p>
            ...
            for (let i = 7, len = forecastList.length; i < len; i+=8 ) {
                ...
                li.innerHTML = `
                    <div class="icon-wrapper">
                        ...
                        <span class="span">
                            <p class="title-2">${parseInt(tempt_max)}$deg</p>
                        </span>
                    </div>
